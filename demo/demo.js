...
DiffLogger.prototype.save = function () {
	if (this.enable) {
		...
		if (this.context) {
			...
			var currentDiffValue = currentDiff ? currentDiff.value : undefined;
			var _diff = getDiff(currentDiffValue);
