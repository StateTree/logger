...
DiffLogger.prototype.save = function () {
	if (this.enable) {
		...
		if (this.context) {
			var state = this.getter.call(this.context);
			var _diff = getDiff(this.prevDiffState, state);
