	...
	if (steps === 0) {
		...
		if (type === "undo") {
			...
			while (steps >= 0) {
				...
				var isLoggableCollectionObject = _diffState['className'] === objectVerifier;
				...
				if (typeof oldState !== 'string') {
					if (typeof newState !== 'string') {
						if (newState['className'] !== oldState['className']) {
							...
							var _isCollectionObject = newState['className'] === objectVerifier;
